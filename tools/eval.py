...
def main():
    ...
    if 'OTB' in args.dataset:
        ...
        # visualization
        if args.vis:
            # draw my tracking results
            for attr, videos in dataset.attr.items():
                draw_success_precision(success_ret, name=dataset.name,
                                       videos=videos, attr=attr, precision_ret=precision_ret)
        ...
        if args.vis:
            draw_success_precision(success_ret, name=dataset.name,
                                ...
                                attr='ALL', precision_ret=precision_ret,

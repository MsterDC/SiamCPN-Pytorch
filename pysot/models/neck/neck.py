...
# ***************** Yao's neck implementation ****************** #
# ***************** Move "center_size" part to afpn head ****************** #
...
class AdjustAllLayer(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        if self.num == 1:
            self.adjust = AdjustLayer(in_channels[0], out_channels[0])
        else:
            for i in range(self.num):
                self.add_module('adjust' + str(i + 2),
    ...
    def forward(self, features):
        if self.num == 1:
            ...
            out = []
            for i in range(self.num):
                adj_layer = getattr(self, 'adjust' + str(i + 2))
